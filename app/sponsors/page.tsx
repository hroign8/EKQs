...
const goldSponsors: SponsorItem[] = [
  ...
  { name: 'Diana Tekle', description: 'Diana Tekle is the founder of Dina Fashion Design, a Uganda-based fashion brand with roots in Eritrea. She specializes in the creation of elegant women’s dresses and bespoke outfits tailored for parties and special occasions, reflecting a refined sense of style and attention to detail. Her journey in fashion began at the age of 13, when she enrolled at Nyala Fashion School in Eritrea. She later advanced her training at next week fashion design college in Ethiopia, where she earned professional certification. With nearly two years of industry experience, Diana skillfully transforms her creative concepts into reality through both sketching and garment construction, producing designs that celebrate femininity, confidence, and individuality. Driven by ambition and vision, Diana aspires to establish herself as an international fashion designer, participate in prestigious global fashion events, and ultimately launch the first major fashion week in Eritrea—creating a platform to showcase and elevate African talent on the world stage.', imageSrc: '/dina-logo-01.svg' },
